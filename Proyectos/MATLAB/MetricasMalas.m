archivosEntreno = dir('..\..\Imagenes\Entreno\Mala Calidad');
archivosValidacion = dir('..\..\Imagenes\Validacion\Mala calidad');
...
Grafico('BRISQUE Imagenes Entreno de Mala Calidad',datosBrisqueEn);
Grafico('PIQE Imagenes Entreno de Mala Calidad',datosPIQE_En);
% Grafica y agrupa las diferentes distancias que les aplica a las imagenes
GraficoNIQE('NIQE Imagenes Entreno de Mala Calidad', datosNIQE_En);
...
writetable(tablaUNIDA, '..\..\Valores de calidad\Matlab\MetricasMalaCalidadEntreno.csv');
...
Grafico('BRISQUE Imagenes Validación de Mala Calidad',datosBrisqueVal);
Grafico('PIQE Imagenes Validación de Mala Calidad',datosPIQEVal);
GraficoNIQE('NIQE Imagenes Validación de Mala Calidad', datosNIQEVal);
...
writetable(tablaUNIDAValidacion, '..\..\Valores de calidad\Matlab\MetricasMalaCalidadValidacion.csv');
